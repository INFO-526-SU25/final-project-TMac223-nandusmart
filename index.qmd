...
-   **Does an expedition’s funding affect safety outcomes?**
    ...
    -   We then relate this composite to safety indicators like member and staff fatalities, high-altitude illnesses, rescue events via scatterplot matrices, concentration curves, and Poisson regression. Stratified visualisations highlight differential risk patterns between commercial and self-organised teams.

Preliminary findings suggest that

\(i\) seasonality and route normalisation remain the strongest predictors of summit success

\(ii\) larger, commercially sponsored teams enjoy slightly higher success but only marginal safety advantages once altitude and weather are controlled; and

\(iii\) resource intensive strategies such as extensive oxygen deployment reduce high-altitude illness yet do not eliminate fatal risk.
